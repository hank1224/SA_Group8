...
class OrderRecord(models.Model):
    ...
    sWash=models.CharField(max_length=6, blank=False, null=False)
    sDry=models.CharField(max_length=6, blank=False, null=False)
    sFold=models.CharField(max_length=6, blank=False, null=False)
